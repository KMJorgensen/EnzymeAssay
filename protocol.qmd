...
You also need to prepare the soil suspensions @sec-soil_susp in advance. Previous versions of this protocol has said that suspensions should be prepared on the day of the assay but the suspensions seem to be stable for at least a week, so they can be prepared in advance. It is, however, always a good idea to compare activities from a freshly made suspension with a stored one to optimize storage for your particular soil type.

### Doing the assay

The assay is done in black 96-well flat-bottom microplates with four technical replicates of each soil suspension (24 samples/plate); see @fig-plate_setup. Prepare three identical plates with soil suspensions; one for doing the incubation, one fluorescence control @sec-fluorescence_ctrl and one quenching control @sec-quenching_ctrl.
...
The standard solutions of MUB (for CBH, BG, NAG, CiBH, aP, and BXD) and MUC (for LAP) are used to make standard curves to be able to convert fluorescence to amounts of formed product (as a proxy for enzyme activity). You only have to do the standard curve once per "assay round". See @fig-plate_standard for plate setup.
...
![Plate setup for hydrolytic enzyme assay. The same setup is used for incubates, T0 control and quenching control plates](Figures/Plate_setup_hydro.JPG){#fig-plate_setup width="391"}

![Plate setup for standard curve](Figures/Plate_setup_standard.JPG){#fig-plate_standard width="557"}

## Chemical information, risk assessment

| 188997-57-4Chemical                   | Formula                   | CAS-number | Storage | Hazards |
|--------------------------|------------|------------|------------|------------|
...
| 4-MUB-𝛽-D-N-diacetyl-chitobioside     | C~26~H~34~N~2~O~13~       |            |         |         |
| 4-MUB-phosphate                       | C~10~H~9~O~6~P            |            |         |         |
| 4-MUB-𝛽-D-xylopyranoside              | C~15~H~16~O~7~            |            |         |         |
| L-leucine-7-amido-4-MUC-hydrochloride | C~16~H~20~N~2~O~3~ · HCl  |            |         |         |
| 4-methylumbelliferone (MUB)           | C~10~H~8~O~3~             | 90-33-5    | 2-8℃    | None    |
| 7-amino-4-methylcoumarin (MUC)        | C~10~H~9~NO~2~            |            |         |         |
| Sodium acetate                        | CH~3~COONa                |            |         |         |
| Sodium hydroxide                      | NaOH                      |            |         |         |
| Glacial acetic acid                   | CH~3~CO~2~H               |            |         |         |
|                                       |                           |            |         |         |
