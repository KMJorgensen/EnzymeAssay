...
Alteration for fluorescence control:

-   Stop reaction immediately after step 2

Alteration for quenching control:
...
Determine the **gain** by measuring one plate with the setting "optimal" and recording the gain. The gain should be manually set to this value for all subsequent measurements in the project.
